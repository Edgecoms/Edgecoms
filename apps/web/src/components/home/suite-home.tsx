				...
				<div className="relative mt-16">
					<div className="grid grid-cols-1 gap-px border border-border bg-border sm:grid-cols-2 lg:grid-cols-3">
						{EDGE_PRODUCTS.map((product) => (
							<article className="flex flex-col bg-bg" key={product.slug}>
								<div className="flex h-[260px] items-center justify-center overflow-hidden px-6 py-8">
									{DIAGRAMS[product.slug]}
								</div>
								<div className="flex flex-1 flex-col gap-2 border-border border-t px-7 py-7">
									...
									<p className="text-pretty text-body-sm text-primary-foreground">
										{product.tagline}
									</p>
