...
const navigationMenuTriggerStyle = cva(
	cn(
		...
		"group/navigation-menu-trigger w-max outline-none data-open:bg-tertiary-hover data-popup-open:bg-tertiary-hover data-open:text-primary-foreground data-popup-open:text-primary-foreground"
	)
);
	...
	return (
		<NavigationMenuPrimitive.Portal>
			<NavigationMenuPrimitive.Positioner
				...
				{...props}
			>
				<NavigationMenuPrimitive.Popup className="data-[ending-style]:easing-[ease] relative h-(--popup-height) w-(--popup-width) xs:w-(--popup-width) origin-(--transform-origin) rounded-3xl bg-transparent text-popover-foreground outline-none transition-[opacity,transform,width,height,scale,translate] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)] data-ending-style:scale-95 data-starting-style:scale-95 data-ending-style:opacity-0 data-starting-style:opacity-0 data-ending-style:duration-150">
