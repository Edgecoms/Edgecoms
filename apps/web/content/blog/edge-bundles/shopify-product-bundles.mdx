...
tldr: "Shopify product bundles group items into one offer so a shopper buys more in a single order. The four types are fixed sets, mix-and-match, volume tiers and frequently-bought-together, and they solve different problems. Price the bundle off the margin you keep, not the discount you advertise, or you will sell more and earn less."
faq:
...
3. **Set the discount so the bundle still clears your margin floor** at the worst case, assuming the baseline buyers all take it.
